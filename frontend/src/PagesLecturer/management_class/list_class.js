        ...
        <div>
            ...
            <Container fluid className={globalstyles['main-background']}>
                ...
                <div style={{ display: 'flex', gap: '10px', marginLeft: '50px' }}>
                    <input className={globalstyles.input} type="text"  value={inputMaLop} onChange={inputValueMaLop} placeholder="Nhập mã lớp" />
                    <input className={globalstyles.input} type="text" value={inputTenLop} onChange={inputValueTenLop} placeholder="Nhập tên lớp" />
